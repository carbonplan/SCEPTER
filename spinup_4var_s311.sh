...
# name of run script
runscript=tunespin_4_newton_inert_buff_v2_clean.py

# ----------------------------------------------------
# --- RUN 
python3 $runscript --spinname $spinname --cec $cec --tph $tph --tec $tec --tsom $tsom --mat $mat --soilmoisture $soilmoisture --qrun $qrun --erosion $erosion --nitrif $nitrif --tsoilco2 $tsoilco2 --poro $poro --alpha $alpha --initguess $initguess --outdir $outdir
